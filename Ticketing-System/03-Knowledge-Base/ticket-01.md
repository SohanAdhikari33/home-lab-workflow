...
1. **TO DO** – Ticket created  
   ![Ticket Created](../01-Ticket-Creation/screenshots/ticket-created.png)
2. **IN PROGRESS** – Started troubleshooting  
   ![Ticket In Progress](../02-Ticket-Resolution/screenshots/ticket-in-progress.png)
3. **Comment** – Password reset performed via Entra ID  
   ![Ticket Comment](../02-Ticket-Resolution/screenshots/ticket-comments.png)
4. **RESOLVED** – Issue fixed  
   ![Ticket Resolved](../02-Ticket-Resolution/screenshots/ticket-resolved.png)
5. **CLOSED** – Final confirmation
   ![Ticket Resolved](../02-Ticket-Resolution/screenshots/ticket-closed.png)
